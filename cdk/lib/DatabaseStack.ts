...
//     // 🔹 IAM Role for CloudWatch Logs (Alternative to Enhanced Monitoring)
//     const cloudwatchLogsRole = new iam.Role(this, 'RDSCloudWatchLogsRole', {
...
//       // 🔹 Define the Writer Instance (WITHOUT `monitoringInterval`)
//       writer: rds.ClusterInstance.serverlessV2('AuroraWriter', {
//         publiclyAccessible: false,
//       }),

//       // 🔹 Enable CloudWatch Logs for monitoring (Alternative to Enhanced Monitoring)
//       cloudwatchLogsExports: ['postgresql'],
//       cloudwatchLogsRetention: cdk.aws_logs.RetentionDays.ONE_MONTH,
//     });

//     // 🔹 Output Secret ARN for Lambda Access
