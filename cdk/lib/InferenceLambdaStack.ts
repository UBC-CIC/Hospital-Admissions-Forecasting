...
//   sagemakerEndpointName: string; // Pass only the SageMaker Endpoint Name
//   dbCluster: rds.DatabaseCluster;
//   dbSecret: secretsmanager.Secret;
// }

// export class InferenceLambdaStack extends cdk.Stack {
//   public readonly inferenceBucket: s3.Bucket; // Define separate bucket for inference data

//   constructor(scope: Construct, id: string, props: InferenceLambdaStackProps) {
//     super(scope, id, props);

//     // 🔹 Create a separate S3 bucket for inference inputs
//     this.inferenceBucket = new s3.Bucket(this, 'InferenceDataBucket', {
//       removalPolicy: cdk.RemovalPolicy.DESTROY,
//       autoDeleteObjects: true,
//     });

//     // 🔹 Use AWS Pre-built Pandas Layer (Region-Specific ARN)
...
//       code: lambda.Code.fromAsset('lambda/inferencing'), // Folder with inference.py
//       environment: {
//         SAGEMAKER_ENDPOINT_NAME: props.sagemakerEndpointName,
//       },
//       timeout: cdk.Duration.seconds(30),
//       memorySize: 512,
//       layers: [pandasLayer], // Attaching pandas layer
//     });
...
//     // 🔹 Configure S3 event notification to trigger inference Lambda on new JSON files
...
//     // Output Lambda function and inference bucket name
